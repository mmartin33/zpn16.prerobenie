...
public class StatDodavatelProduktyNastroje {

    public static void exportDoXLS(List<StatistikaBodov> statList) {

    }

    public static Map<BigInteger, Firma> Dodavatelia(LocalDate dod, LocalDate ddo, int rok) {
        List<BigInteger> result1=null;
        EntityManager em1;
